<%@ Page Title="" Language="C#" MasterPageFile="~/Website.Master" AutoEventWireup="true" CodeBehind="adminmembermanagement.aspx.cs" Inherits="GameSite.adminmembermanagement" %>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-12">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox6" runat="server" placeholder="Full Postal Address" TextMode="MultiLine" Rows="1" ReadOnly="True"></asp:TextBox>
                        </div>
                     </div>
                  </div>
         ...
         <div class="col-md-7">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:tastesoftheworldDBConnectionString %>" SelectCommand="SELECT * FROM [user_info_tbl]"></asp:SqlDataSource>
                     <div class="col">

<%@ Page Title="" Language="C#" MasterPageFile="~/Website.Master" AutoEventWireup="true" CodeBehind="restaurantmanagement.aspx.cs" Inherits="GameSite.restaurantmanagement" %>
         ...
         <div class="col-md-7">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:tastesoftheworldDBConnectionString %>" SelectCommand="SELECT * FROM [restaurant_master_tbl]"></asp:SqlDataSource>
                     <div class="col">
